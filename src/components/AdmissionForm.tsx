...
export default function AdmissionForm({ onSuccess, inline = false }: AdmissionFormProps) {
  ...
  return (
    <>
          ...
          <div className={styles.stepper}>
            ...
            {steps.map((step) => (
              <div
                ...
                } ${currentStep > step.num ? styles.stepItemCompleted : ""}`}
              >
      ...
      <div
        className={`${styles.modalInner} ${inline ? styles.inlineInner : ""}`}
        data-lenis-prevent={!inline}
      >
        {!isSuccess ? (
                ...
                >
                      ...
                      <DatePicker
                        ...
                        onChange={(date: Date | null) => {
                          if (date) {
                            ...
                            handleChange({
                              target: { name: "dob", value: `${yyyy}-${mm}-${dd}` },
                            } as any);
                          }
                        }}
                        onChangeRaw={(e: any) => {
                  ...
                  <div className={styles.inputGroup}>
                    ...
                    <input
                      ...
                      onChange={handleChange}
                      placeholder="Where did they study before?"
                    />
                  </div>
                </motion.div>
              )}
          ...
          >
            ...
            <p>
              Thank you for choosing Little Angel&apos;s English School.
              <br />Our team will contact you on <strong>{formData.mobileNumber}</strong> shortly.
            </p>
          </motion.div>
        )}
      </div>
